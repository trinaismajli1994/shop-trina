            ...
            if ( function_exists( 'wc_get_gallery_image_html' ) ) :
                ...
                <div class="<?php echo esc_attr( implode( ' ', array_map( 'sanitize_html_class', $wrapper_classes ) ) ); ?>" data-columns="<?php echo esc_attr( $columns ); ?>" style="opacity: 0; transition: opacity .25s ease-in-out;">
                    ...
                    if ( $product->is_on_sale() ) :
                        echo apply_filters( 'botiga_quick_view_sale_flash', '<span class="onsale">' . esc_html__( 'Zbritje!', 'botiga' ) . '</span>', get_post( $product_id ), $product ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
                    endif; ?>
        ...
        <div class="col-lg-6">
            <div class="botiga-quick-view-summary product-gallery-summary">
                    ...
                    if ( $rating_count > 0 ) : ?>
                        ...
                        <div class="woocommerce-product-rating">
                            ...
                            <?php if ( comments_open( $product_id ) ) : ?>
                                <a href="<?php echo esc_url( get_permalink( $product_id ) ); ?>#reviews" class="woocommerce-review-link" rel="nofollow">(<?php /* translators: %s: customer review text */ printf( _n( '%s vlerësimi i klientit', '%s vlerësimet e klientëve', $review_count, 'botiga' ), '<span class="count">' . esc_html( $review_count ) . '</span>' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>)</a>
                            <?php endif ?>
                        </div>
                ...
                <div class="product_meta">
                    ...
                    <?php echo wc_get_product_category_list( $product->get_id(), ', ', '<span class="posted_in">' . _n( 'Kategoria:', 'Categories:', count( $product->get_category_ids() ), 'botiga' ) . ' ', '</span>' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
