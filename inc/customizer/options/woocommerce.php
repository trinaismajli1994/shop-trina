...
$wp_customize->add_control( new \Kirki\Control\Sortable( $wp_customize, 'shop_card_elements', array(
	...
	'section' 			=> 'woocommerce_product_catalog',
	'choices' 			=> array(
		'woocommerce_template_loop_product_title' 	=> esc_html__( 'Titulli', 'botiga' ),
		'woocommerce_template_loop_rating' 			=> esc_html__( 'Komente', 'botiga' ),
		'woocommerce_template_loop_price' 			=> esc_html__( 'Çmimi', 'botiga' ),
		'botiga_loop_product_category' 				=> esc_html__( 'Kategoria', 'botiga' ),
		'botiga_loop_product_description' 			=> esc_html__( 'Përshkrim i shkurtër', 'botiga' ),
	),
	'priority'	 => 140
) ) );
...
$wp_customize->add_setting(
	...
	array(
		'sanitize_callback' => 'botiga_sanitize_text',
		'default'           => esc_html__( 'Zbritje!', 'botiga' ),
	)       
);
